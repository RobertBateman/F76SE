...
#define DEFINE_MEMBER_FN_2(fnName, retnType, addr, ...)					\
	...
	FORCE_INLINE retnType fnName(T1 && t1, T2 && t2) {	_ERROR("1");					\
	struct empty_struct {};													\
	typedef retnType(empty_struct::*_##fnName##_type)(__VA_ARGS__);			\
	const static uintptr_t address = addr + RelocationManager::s_baseAddr;	\
	_##fnName##_type fn = *(_##fnName##_type*)&address;						\
...
#define DEFINE_MEMBER_FN_3(fnName, retnType, addr, ...)					\
	...
	FORCE_INLINE retnType fnName(T1 && t1, T2 && t2, T3 && t3) {_ERROR("2");			\
	struct empty_struct {};													\
	typedef retnType(empty_struct::*_##fnName##_type)(__VA_ARGS__);			\
	const static uintptr_t address = addr + RelocationManager::s_baseAddr;	\
	_##fnName##_type fn = *(_##fnName##_type*)&address;						\
...
#define DEFINE_MEMBER_FN_4(fnName, retnType, addr, ...)					\
	...
	FORCE_INLINE retnType fnName(T1 && t1, T2 && t2, T3 && t3, T4 && t4) {_ERROR("3");	\
	struct empty_struct {};													\
	typedef retnType(empty_struct::*_##fnName##_type)(__VA_ARGS__);			\
	const static uintptr_t address = addr + RelocationManager::s_baseAddr;	\
	_##fnName##_type fn = *(_##fnName##_type*)&address;						\
...
#define DEFINE_MEMBER_FN_5(fnName, retnType, addr, ...)								\
	...
	FORCE_INLINE retnType fnName(T1 && t1, T2 && t2, T3 && t3, T4 && t4, T5 && t5) {_ERROR("4");	\
	struct empty_struct {};																\
	typedef retnType(empty_struct::*_##fnName##_type)(__VA_ARGS__);						\
	const static uintptr_t address = addr + RelocationManager::s_baseAddr;				\
	_##fnName##_type fn = *(_##fnName##_type*)&address;									\
...
#define DEFINE_MEMBER_FN_6(fnName, retnType, addr, ...)										\
	...
	FORCE_INLINE retnType fnName(T1 && t1, T2 && t2, T3 && t3, T4 && t4, T5 && t5, T6 && t6) {_ERROR("5");	\
	struct empty_struct {};																		\
	typedef retnType(empty_struct::*_##fnName##_type)(__VA_ARGS__);								\
	const static uintptr_t address = addr + RelocationManager::s_baseAddr;						\
	_##fnName##_type fn = *(_##fnName##_type*)&address;											\
...
#define DEFINE_MEMBER_FN_7(fnName, retnType, addr, ...)													\
	...
	FORCE_INLINE retnType fnName(T1 && t1, T2 && t2, T3 && t3, T4 && t4, T5 && t5, T6 && t6, T7 && t7) {_ERROR("6");	\
	struct empty_struct {};																					\
	typedef retnType(empty_struct::*_##fnName##_type)(__VA_ARGS__);											\
	const static uintptr_t address = addr + RelocationManager::s_baseAddr;									\
	_##fnName##_type fn = *(_##fnName##_type*)&address;														\
...
#define DEFINE_MEMBER_FN_8(fnName, retnType, addr, ...)																\
	...
	FORCE_INLINE retnType fnName(T1 && t1, T2 && t2, T3 && t3, T4 && t4, T5 && t5, T6 && t6, T7 && t7, T8 && t8) {_ERROR("7");		\
	struct empty_struct {};																								\
	typedef retnType(empty_struct::*_##fnName##_type)(__VA_ARGS__);														\
	const static uintptr_t address = addr + RelocationManager::s_baseAddr;												\
	_##fnName##_type fn = *(_##fnName##_type*)&address;																	\
...
#define DEFINE_MEMBER_FN_9(fnName, retnType, addr, ...)																			\
	...
	FORCE_INLINE retnType fnName(T1 && t1, T2 && t2, T3 && t3, T4 && t4, T5 && t5, T6 && t6, T7 && t7, T8 && t8, T9 && t9) {_ERROR("8");		\
	struct empty_struct {};																											\
	typedef retnType(empty_struct::*_##fnName##_type)(__VA_ARGS__);																	\
	const static uintptr_t address = addr + RelocationManager::s_baseAddr;															\
	_##fnName##_type fn = *(_##fnName##_type*)&address;																				\
...
#define DEFINE_MEMBER_FN_10(fnName, retnType, addr, ...)																						\
	...
	FORCE_INLINE retnType fnName(T1 && t1, T2 && t2, T3 && t3, T4 && t4, T5 && t5, T6 && t6, T7 && t7, T8 && t8, T9 && t9, T10 && t10) {_ERROR("9");		\
	struct empty_struct {};																														\
	typedef retnType(empty_struct::*_##fnName##_type)(__VA_ARGS__);																				\
	const static uintptr_t address = addr + RelocationManager::s_baseAddr;																		\
	_##fnName##_type fn = *(_##fnName##_type*)&address;																							\
